...
int manikin_ble_decode_msg(const uint8_t *in_buff, manikin_ble_msg_t *out_buff);

int manikin_ble_encode_msg(const manikin_ble_msg_t *in_buff, uint8_t out_buff);
